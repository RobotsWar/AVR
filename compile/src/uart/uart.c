...
void uart_putc(unsigned char data)
{
...
#if defined (ATMEGA_USART0 )
    UART0_CONTROL = _BV(RXCIE0)|(1<<TXEN0);
#endif
    ...
    UART0_CONTROL    |= _BV(UART0_UDRIE)|_BV(UART0_TXCIE);
